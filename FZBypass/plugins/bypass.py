...
🛃 <b>Powered By :</b> @infinity_botzz <i>(Bypass Topic)</i>''',
        ...
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('🎓Channel', url='https://t.me/infinity_botzz'), InlineKeyboardButton('🔍 Use Me Here', url="https://t.me/+hxpKxRui5jE2N2Y1")]
            ])
    )
...
🎛 <b>Inline Use :</b> !bp [Single Link]''',
                ...
                reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("Update Channel", url="https://t.me/infinity_botzz"),
